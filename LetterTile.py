...
class LetterTile(Btn.Button):
	def __init__(
		...
		super(LetterTile, self).__init__(colour, position, width, height, outline_colour, text, text_size, text_colour, fade_value, is_active, outline_size)
